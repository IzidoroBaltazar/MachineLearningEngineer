...
\[ 2 years data \]
\[ 2*252 trading days = 504 \]
\[ 504 * 7 (number of features in a day) = 3024 features\]
Output of model will be classification of input. (two years, 2*252 days = 504 days * number of values  vector) as trade (long/short position) or do not trade.
